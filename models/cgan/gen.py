...
class generator(nn.Module):
  ...
  def __init__(self, d=128, img_size=100):
    ...
    self.deconv1_1 = nn.ConvTranspose2d(100, d * 4, 2, 1, 0)
    self.deconv1_1_bn = nn.BatchNorm2d(d * 4)
    self.deconv1_2 = nn.ConvTranspose2d(1, d * 4, 2, 1, 0)
    ...
    self.deconv4 = nn.ConvTranspose2d(d * 2, d, 16, 8, 1)
    self.deconv4_bn = nn.BatchNorm2d(d)
    self.deconv5 = nn.ConvTranspose2d(d, 1, 30, 10, 1)
